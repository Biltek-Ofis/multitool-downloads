...
& {
    ...
    $URLs = @(
        'https://raw.githubusercontent.com/Biltek-Ofis/multitool-downloads/refs/heads/master/MAS_AIO.cmd?v=7',
        'https://raw.githubusercontent.com/Biltek-Ofis/multitool-downloads/refs/heads/master/MAS_AIO.cmd?v=7',
        'https://raw.githubusercontent.com/Biltek-Ofis/multitool-downloads/refs/heads/master/MAS_AIO.cmd?v=7'
    )
    ...
    $releaseHash = '0C24603A2EC3EF11F6456F2DDD5DA8CC8A95B76DA9EBB76BA985AB9282274650'
    ...
    $response = $response -replace "`r`n", "`n" -replace "`n", "`r`n"
    # Set-Content -Path $FilePath -Value "@::: $rand `r`n$response" -Encoding ASCII
    $utf8NoBom = New-Object System.Text.UTF8Encoding $false
    [System.IO.File]::WriteAllText($FilePath, "@::: $rand `r`n$response", $utf8NoBom)
    CheckFile $FilePath
